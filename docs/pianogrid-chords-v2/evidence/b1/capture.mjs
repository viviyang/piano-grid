...
const phase=process.argv[2]||'before',out=`docs/pianogrid-chords-v2/evidence/b1/${phase}`;
...
if(phase==='after'){
 const before=JSON.parse(fs.readFileSync('docs/pianogrid-chords-v2/evidence/b1/before/dom.json'));
 ...
 fs.writeFileSync('docs/pianogrid-chords-v2/evidence/b1/comparison.json',JSON.stringify(comparison,null,2));console.log(JSON.stringify(comparison,null,2));
}
