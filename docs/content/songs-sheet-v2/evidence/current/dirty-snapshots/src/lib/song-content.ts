...
const verifiedAcquisitionFormats: Record<string, string> = {
  'cr-04-1': 'Printed book or Hal Leonard Digital Book. The digital book is online-only and cannot be downloaded or printed.',
};
