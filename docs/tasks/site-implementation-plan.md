...
日期：2026-09-10。唯一当前批次：08 上线准备。实现与开发者回归已完成，当前状态 `待独立验收`；不自签独立 PASS。01–07 均已由独立报告或用户确认同步为 `review_passed / PASS_WITH_NOTES`，其产品范围保持不变。

[已核实] 全站127 URL保持，17先做、91后做、19暂不做。源数据准备状态不变；下表仅工程状态，全部 production published=false。现有 A minor 是前阶段成果，本轮回归单列，不算新建页面。

## 首轮17页

| URL | 模板 | 原优先级 | 工程批次 | source_groups | 实现/测试状态 |
|---|---|---|---|---|---|
| / | T01 | 先做 | 07-site-integration | — | review_passed / PASS_WITH_NOTES（07报告）；08 待独立验收 |
| /tools | T02 | 先做 | 07-site-integration | P113 | review_passed / PASS_WITH_NOTES（07报告）；08 待独立验收 |
| /songs | T15 | 先做 | 04-songs | P002, P009, P014, P018, P022, P041, P042, P043 | review_passed / PASS_WITH_NOTES（04报告，用户已接受）；08 待独立验收 |
| /songs/easy | T16 | 先做 | 04-songs | P001, P006, P036, P037, P039, P040 | review_passed / PASS_WITH_NOTES（04报告，用户已接受）；08 待独立验收 |
| /tools/blank-sheet-music | T19 | 先做 | 06-blank-sheet | P079 | review_passed / PASS_WITH_NOTES（06报告，用户已接受）；08 待独立验收 |
| /keyboard-notes | T03 | 先做 | 02-keyboard-notes | P117, P118, P120, P122, P123, P124, P127, P129, P130, P133, P134, P138, P139, P140, P141, P142, P147 | review_passed / PASS_WITH_NOTES（02报告，用户已接受）；08 待独立验收 |
| /keyboard-notes/labeled | T04 | 先做 | 02-keyboard-notes | P119, P137, P223, P241 | review_passed / PASS_WITH_NOTES（02报告，用户已接受）；08 待独立验收 |
| /keyboard-notes/chart | T05 | 先做 | 02-keyboard-notes | P121, P132, P143, P145, P146 | review_passed / PASS_WITH_NOTES（02报告，用户已接受）；08 待独立验收 |
| /chords | T06 | 先做 | 01-chords | P148, P154, P158, P168, P170, P171, P238, P247 | review_passed / PASS_WITH_NOTES（01报告）；08 待独立验收 |
| /chords/a-major | T07 | 先做 | 01-chords | P149 | review_passed / PASS_WITH_NOTES（01报告）；08 待独立验收 |
| /chords/a-minor | T07 | 先做 | 01 regression | P151 | review_passed / PASS_WITH_NOTES（01报告）；08 待独立验收 |
| /chords/c-major | T07 | 先做 | 01-chords | P163 | review_passed / PASS_WITH_NOTES（01报告）；08 待独立验收 |
| /scales | T11 | 先做 | 03-scales | P179, P180, P181, P190, P196, P204, P208, P210, P213, P214, P222, P224, P233, P235 | review_passed / PASS_WITH_NOTES（03报告，用户已接受）；08 待独立验收 |
| /scales/c-major | T12 | 先做 | 03-scales | P183 | review_passed / PASS_WITH_NOTES（03报告，用户已接受）；08 待独立验收 |
| /scales/a-minor | T12 | 先做 | 03-scales | P184 | review_passed / PASS_WITH_NOTES（03报告，用户已接受）；08 待独立验收 |
| /guide | T21 | 先做 | 05-guides | P226, P240, P255 | review_passed / PASS_WITH_NOTES（05报告，用户已接受）；08 待独立验收 |
| /guide/read-sheet-music | T22 | 先做 | 05-guides | P218, P228, P229, P236, P248, P249 | review_passed / PASS_WITH_NOTES（05报告，用户已接受）；08 待独立验收 |
...
- 08：`checks/release/08/seo-audit.md`、`seo-pages.json`、before/after HTML、headers、1440/390 截图、链接图与命令日志；发布预览和标准保护态均为17/17，业务回归通过。当前为 `待独立验收`。`docs/release/release-readiness.md` 是唯一上线门槛汇总。`noindex,nofollow` 保持。
- 下一具体动作：在独立验收对话读取 CONTINUE-HERE.md，执行“验收 08”；主开发停止。不进入后做页面或部署。
