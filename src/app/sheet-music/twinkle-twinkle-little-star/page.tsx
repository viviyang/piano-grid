...
const page = getPagePatch('/sheet-music/twinkle-twinkle-little-star');
...
export default function Page(){ return <SheetMusicPage url="/sheet-music/twinkle-twinkle-little-star"/>; }
