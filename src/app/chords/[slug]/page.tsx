...
import { N2C_DETAIL_ROUTES, isN2CChordDetailRoute } from '@/lib/chord-n2c-content';
import { N2D_DETAIL_ROUTES, isN2DChordDetailRoute } from '@/lib/chord-n2d-content';

export function generateStaticParams() {
  return [...EXPANSION_DETAIL_ROUTES,...N2B_DETAIL_ROUTES,...N2C_DETAIL_ROUTES,...N2D_DETAIL_ROUTES].map(url => ({ slug: url.split('/').at(-1)! }));
}
