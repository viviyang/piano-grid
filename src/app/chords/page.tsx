...
export function generateMetadata(){const {metadata}=getChordCenter();return editorialMetadata({title:metadata.title,description:metadata.description,alternates:{canonical:metadata.canonical_path},robots:{index:true,follow:true}});}
