...
export function EasySongChooser({ resources, sections }: { resources: SongResource[]; sections: SongGoal[] }) {
  ...
  return <section className="sg-easy-chooser" aria-labelledby="sg-easy-heading">
    <div className="sg-discovery-head"><div><p className="sg-overline">{resources.length} specific versions</p><h2 id="sg-easy-heading">Choose by starting point</h2></div><p>Each view keeps the exact arrangement, acquisition route and reason for choosing it together.</p></div>
