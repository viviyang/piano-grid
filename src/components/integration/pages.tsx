...
export function HomePage(){
  ...
  return <div className="am-page in-page home-page"><a className="am-skip ph-skip" href="#main">Skip to content</a><HomeHeader/><main id="main" tabIndex={-1}>
    ...
    <section className="pr-container ph-resources" aria-labelledby="home-resources-title"><div className="ph-resource-intro"><p className="ph-eyebrow">The useful little things</p><h2 id="home-resources-title">Keep them<br/>within reach.</h2><p>References for the questions that come up when you sit down to play.</p></div><div className="ph-resource-list"><a className="pr-breathe-surface" href="/keyboard-notes/chart"><span>01</span><div><h3>Piano notes chart</h3><p>Match note names, piano keys, and pitches.</p></div><HomeArrow/></a><a className="pr-breathe-surface" href="/tools/blank-sheet-music"><span>02</span><div><h3>Blank sheet music</h3><p>A clear page for your next musical idea.</p></div><HomeArrow/></a><a className="pr-breathe-surface" href="/guide"><span>03</span><div><h3>A beginner’s starting point</h3><p>Get familiar with the keyboard and the basics.</p></div><HomeArrow/></a></div></section>
