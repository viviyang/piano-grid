...
import {localPreview} from '@/lib/site-content';
...
export function ChordCenterPage({model}:{model:CenterModel}) {
 ...
 {id==='chords-print'&&<CenterPrintActions/>}{id==='chords-next'&&localPreview&&c.links.map(l=><a className="am-button am-tertiary" key={l.url} href={l.url}>{l.label}</a>)}
 </div></section>)}
