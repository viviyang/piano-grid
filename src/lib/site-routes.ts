...
export const SITE_NAVIGATION = [
  ...
  },
  {
    ...
    href: '/sheet-music',
    children: [
      { label: 'Easy Sheet Music', href: '/sheet-music/easy' },
      { label: 'Beginner Sheet Music', href: '/sheet-music/beginner' },
      { label: 'Hot Cross Buns', href: '/sheet-music/hot-cross-buns' },
      { label: 'Twinkle, Twinkle', href: '/sheet-music/twinkle-twinkle-little-star' },
      { label: 'Ode to Joy', href: '/sheet-music/ode-to-joy' },
    ],
  },
  {
    label: 'Learn',
