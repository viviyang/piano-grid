...
export const SEO_COPY: Record<string, Copy> = {
  ...
  '/chords/c-major': { title: 'C Major Chord: Piano Notes, Inversions & Practice | PianoGrid', h1: 'C Major Chord', description: 'Learn the C major chord on piano with C–E–G notes, keyboard diagrams, inversions and fingering examples. Hear the chord and practice finding its notes.' },
