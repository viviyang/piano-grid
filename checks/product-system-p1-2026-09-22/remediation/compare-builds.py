...
r=Path.cwd();out=r/'checks/product-system-p1-2026-09-22/remediation';a=r/'.next-p1-final/server/app';b=r/'.next-p1-remediation-clock/server/app'
def meta(p):
