...
try {
  ...
  check('Sitemap has 171 routes and includes chord tools', (xml.match(/<loc>/g) || []).length === 171 && ['/chords/by-key','/chord-progressions','/chords/finder','/chords/c-flat-major','/chords/major','/chords/minor','/chords/seventh','/chords/add'].every(route => xml.includes(`https://pianogrid.com${route}</loc>`)), (xml.match(/<loc>/g) || []).length);
