...
try {
  ...
  allowedComponents.push(...['feedback-availability.tsx','feedback-dialog.tsx','feedback-entry.tsx','page-feedback.tsx','feedback.css'].map(name=>`src/components/feedback/${name}`));
  ...
  allowedPages.push('src/app/api/feedback/route.ts');
