...
try {
  ...
  const allowedPages=['src/app/page.tsx','src/app/tools/page.tsx','src/app/chords/page.tsx','src/app/chords/[slug]/page.tsx',...['major','minor','diminished','augmented','suspended','a-minor','a-major','c-major','g-major','c-minor','e-major','b-major','a-flat-major','c-flat-major','by-key','finder'].map(n=>`src/app/chords/${n}/page.tsx`)];
  ...
  check('Only ninety-seven authorized routes', JSON.stringify(srcFiles.filter(p => /\/(page|route|not-found)\.[mc]?[jt]sx?$/.test(p)).sort()) === JSON.stringify([...allowedPages].sort()));
  ...
  check('Only authorized static assets', publicFiles.every(p => ['public/favicon.ico','public/favicon.svg','public/favicon-96x96.png','public/apple-touch-icon.png','public/icon-192.png','public/icon-512.png','public/assets/home/east-lake-grand-piano.webp','public/assets/home/east-lake-piano-hero.png','public/assets/home/pianogrid-hero-sunset.png','public/assets/chords/a-minor-notes-inversions.pdf','public/assets/guides/piano-starter-and-reading.pdf','public/downloads/scales/pianogrid-scales-notes-check-worksheet.pdf','public/downloads/scales/pianogrid-scales-starter-reference.pdf','public/reference/assets/chord-a-major.pdf','public/reference/assets/chord-c-major.pdf',...["g-major","c-minor","e-major","b-major","a-flat-major","c-flat-major",...expansionSlugs,...n2bSlugs].flatMap(slug=>[`public/reference/assets/chord-${slug}.pdf`,`public/reference/assets/chord-${slug}.svg`]),'public/reference/assets/blank-piano-staff-letter.pdf','public/reference/assets/blank-piano-staff-a4.pdf','public/reference/assets/blank-piano-staff-preview.svg','public/reference/preserved-chords/assets/piano-chord-chart-selected.pdf', ...[88,61].flatMap(n=>['octaves','letters'].map(m=>`public/reference/generated/keyboard-notes/labeled-${n}-${m}.pdf`))].includes(p)));
