...
try {
  ...
  check('Sitemap has 171 routes and includes final chord routes', (xml.match(/<loc>/g) || []).length === 171 && ['/chord-progressions','/chords/finder','/chords/c-flat-major','/chords/major','/chords/minor','/chords/seventh','/chords/add'].every(route => xml.includes(`https://pianogrid.com${route}</loc>`)));
